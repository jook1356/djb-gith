...
export const metadata: Metadata = {
  ...
  description:
    "프론트엔드, 백엔드 개발 경험과 인사이트를 공유하는 개발자 김동주의 기술 블로그입니다. React, Node.js, TypeScript 등 실무 경험을 바탕으로 한 깊이 있는 기술 콘텐츠를 제공합니다.",
  keywords: [
    "개발 블로그",
    "프론트엔드",
    "백엔드",
  ...
  openGraph: {
    ...
    description:
      "프론트엔드, 백엔드 개발 경험과 인사이트를 공유하는 개발자 김동주의 기술 블로그입니다.",
  ...
  twitter: {
    ...
    title: "김동주의 개발 블로그",
    description:
      "프론트엔드, 백엔드 개발 경험과 인사이트를 공유하는 기술 블로그",
    images: ["/og-image.jpg"],
    creator: "@jook1356",
    site: "@jook1356",
  },
